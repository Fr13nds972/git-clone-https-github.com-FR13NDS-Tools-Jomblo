...
sleep 0.2
echo $hijau "Hi...$nama, selamat datang di script MR.FR13NDS"
sleep 3
...
echo $putih"==================================================================="
sleep 0.1
echo $merah" Author    : MR.FR13NDS        "
sleep 0.1
echo $putih" Youtube   :  https://m.youtube.com/channel/UC1XLAKvbMhmOWPdNIzbfEpg   "
sleep 0.1
echo $merah" Github    : https://github.com/MR.FR13NDS/Tools-Jomblo  "
sleep 0.1
echo $putih" Thanks To : [ICA]IndonesiaCyberAmry "
sleep 0.1
echo $merah"===================================================================="
sleep 0.1
echo $putih"===================================================================="
...
clear
  ...
  then
      ...
      echo "404 No Found : input yg anda masukan tidak ada "
      sleep 2
      echo $hijau "masukan input yang benar"
      sleep 3
clear
      echo $ulang
  fi
